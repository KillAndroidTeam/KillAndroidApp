import org.gradle.internal.impldep.com.sun.xml.bind.api.impl.NameConverter
...
//        String succeedStr = new String(sb.toString().getBytes(StandardCharsets.ISO_8859_1), StandardCharsets.UTF_8);
        print sb.toString()
        return contents
    }
